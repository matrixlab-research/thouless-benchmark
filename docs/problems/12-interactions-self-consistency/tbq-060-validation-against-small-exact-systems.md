...
source_requirement: TB-REQ-060
status: proposed
acceptance_class: reference
lkm_snapshot: 2026-07-27
---

# TBQ-060 — Validation against small exact systems

## Scientific question

How accurate is the approximation where exact diagonalization is possible?
...
Compare energies, densities, gaps, and correlations on small clusters over U, V, and
filling, then extend the same workflow to larger systems.

## Expected result

Mean-field is exact in known limits and its controlled deviations from exact clusters
are quantified rather than treated as solver error.
...
Report error maps and correctly recover noninteracting and fully polarized limits.
...
Hide an intermediate-coupling cluster and flux sector.
...
- Source requirement: [`TB-REQ-060`](../../tight-binding-domain-benchmark-requirements.md)
