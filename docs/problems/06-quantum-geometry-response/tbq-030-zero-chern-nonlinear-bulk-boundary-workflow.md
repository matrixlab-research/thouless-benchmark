...
source_requirement: TB-REQ-030
status: executable
acceptance_class: convergence
lkm_snapshot: 2026-07-27
---

# TBQ-030 — Zero-Chern nonlinear bulk-boundary workflow

## Scientific question

For a Chern-trivial insulator with finite intrinsic nonlinear Hall response, what
boundary and open-device signatures exist?
...
Reuse one Hamiltonian for periodic geometric response, multiple finite terminations, and
lead-attached nonlinear or weak-bias observables.

## Expected result

The bulk nonlinear response is finite while the Chern number is zero; boundary
polarization, magnetization, or transport may be termination dependent, and protected
edge eigenstates are not assumed.
...
Same-Hamiltonian provenance, converged bulk response, zero Chern within 1e-5, and
falsifiable reporting of each boundary outcome.
...
Hide lattice family, termination, contacts, disorder, and symmetry-breaking orientation.
...
- Source requirement: [`TB-REQ-030`](../../tight-binding-domain-benchmark-requirements.md)
