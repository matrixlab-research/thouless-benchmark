...
source_requirement: TB-REQ-026
status: proposed
acceptance_class: exact
lkm_snapshot: 2026-07-27
---

# TBQ-026 — Gauge covariance of geometric tensors

## Scientific question

Are Berry curvature and quantum metric stable under phase and degenerate-subspace gauge
changes?
...
Compute Abelian and subspace geometric tensors using analytic derivatives and discrete
overlaps under randomized gauges.

## Expected result

Curvature, metric eigenvalues, and integrated tensors are gauge invariant; the metric is
...
Tensor mismatch below 1e-7 and no metric eigenvalue below -1e-10 after convergence.
...
Hide a nearly degenerate band pair and a discontinuous gauge.
...
- Source requirement: [`TB-REQ-026`](../../tight-binding-domain-benchmark-requirements.md)
