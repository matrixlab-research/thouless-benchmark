...
source_requirement: TB-REQ-098
status: proposed
acceptance_class: reference
lkm_snapshot: 2026-07-27
---

# TBQ-098 — Identifiability and predictive calibration

## Scientific question

Which parameters are actually determined by the observations, and are predictive
...
Estimate local sensitivity, posterior or profile uncertainty, and prediction intervals
on repeated noisy synthetic data.

## Expected result

Unidentifiable combinations retain broad uncertainty, while nominal intervals attain
...
90 to 98 percent coverage for nominal 95 percent prediction intervals on hidden
replicates.
...
Hide a rank-deficient observation design and new noise realization.
...
- Source requirement: [`TB-REQ-098`](../../tight-binding-domain-benchmark-requirements.md)
