...
source_requirement: TB-REQ-099
status: proposed
acceptance_class: reference
lkm_snapshot: 2026-07-27
---

# TBQ-099 — Independent forward validation of inverse designs

## Scientific question

Does an optimized structure achieve its target when recomputed independently and
perturbed realistically?
...
Optimize geometry or hoppings for target spectra or conductance, then rebuild and solve
with an independent forward path and perturbation ensemble.

## Expected result

The independent calculation reaches the target within tolerance and performance degrades
gracefully under fabrication-like perturbations.
...
Target error below the declared threshold and robustness percentile above the
predeclared minimum.
...
Hide the forward mesh, solver, and perturbation seeds.
...
- Source requirement: [`TB-REQ-099`](../../tight-binding-domain-benchmark-requirements.md)
