...
source_requirement: TB-REQ-087
status: proposed
acceptance_class: exact
lkm_snapshot: 2026-07-27
---

# TBQ-087 — Explicit representation mapping

## Scientific question

Are units, bases, Brillouin zones, geometries, and parameters aligned before cross-scale
comparison?
...
Apply and invert basis projections, zone folding, coordinate transforms, and unit
conversions on analytic controls.

## Expected result

Round trips recover the original representation, state counts match, and no apparent
discrepancy is caused by a convention mismatch.
...
Round-trip residual below 1e-10 and exact integer multiplicities.
...
Hide a folded zone and nonorthogonal projection.
...
- Source requirement: [`TB-REQ-087`](../../tight-binding-domain-benchmark-requirements.md)
