...
source_requirement: TB-REQ-089
status: proposed
acceptance_class: convergence
lkm_snapshot: 2026-07-27
---

# TBQ-089 — Discrepancy decomposition

## Scientific question

When models disagree, can the error be separated into numerical, finite-size, parameter,
and model-form components?
...
Run nested refinement and parameter uncertainty sweeps, then compare against an enriched
model.

## Expected result

Numerical and finite-size errors shrink under refinement; persistent discrepancy is
assigned to parameter or model inadequacy with evidence.
...
Reported error components upper-bound the observed discrepancy on public controls.
...
Hide a case with a missing interaction rather than numerical error.
...
- Source requirement: [`TB-REQ-089`](../../tight-binding-domain-benchmark-requirements.md)
