...
source_requirement: TB-REQ-093
status: proposed
acceptance_class: convergence
lkm_snapshot: 2026-07-27
---

# TBQ-093 — Separated numerical error budget

## Scientific question

Can truncation, iterative, stochastic, broadening, finite-size, and discretization
errors be distinguished?
...
Vary one control at a time and compare observed error with component estimates and their
combined bound.

## Expected result

Each estimate shrinks with its refinement parameter and the combined budget covers the
...
At least 90 percent empirical coverage without a component underestimated by more than
factor two.
...
Hide the dominant error source.
...
- Source requirement: [`TB-REQ-093`](../../tight-binding-domain-benchmark-requirements.md)
