...
source_requirement: TB-REQ-051
status: proposed
acceptance_class: convergence
lkm_snapshot: 2026-07-27
---

# TBQ-051 — Equivalent representations of a drive

## Scientific question

Do harmonic, piecewise, and sampled representations of the same time-dependent
Hamiltonian generate the same evolution?
...
Encode matched sinusoidal and piecewise protocols, propagate one period, and compare
unitary operators and observables.

## Expected result

Representations converge to the same one-period evolution as harmonic cutoff or time
...
Operator distance below 1e-7 at the final refinement and unitary residual below 1e-10.
...
Hide a phase-shifted and pulsed waveform.
...
- Source requirement: [`TB-REQ-051`](../../tight-binding-domain-benchmark-requirements.md)
