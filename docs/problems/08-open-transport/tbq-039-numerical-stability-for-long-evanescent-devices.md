...
source_requirement: TB-REQ-039
status: executable
acceptance_class: scaling
lkm_snapshot: 2026-07-27
---

# TBQ-039 — Numerical stability for long evanescent devices

## Scientific question

Can transport remain stable when naive transfer products would overflow or underflow?
...
Scale gapped or weakly transmitting devices to L=100000 and compare stable scattering or
Green formulations across partitions.

## Expected result

Log transmission follows the analytic decay rate without NaN or loss of current balance;
repartitioning does not change the result.
...
Decay-rate error below 1 percent over at least six decades of transmission.
...
Hide the longest length and strongest evanescence.
...
- Source requirement: [`TB-REQ-039`](../../tight-binding-domain-benchmark-requirements.md)
