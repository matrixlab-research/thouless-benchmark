...
# TBQ-037 — Scattering conservation and local continuity

## Scientific question

Does open transport conserve probability and satisfy the lattice continuity equation
locally?
...
Compute scattering matrices, lead flux, local density, bond currents, and onsite sources
for lossless and absorbing devices.

## Expected result

Lossless S is unitary and local current divergence vanishes; declared absorbers produce
matching negative source terms.
...
Unitarity and normalized continuity residual below 1e-9 on reference cases.
...
Hide terminal count and add a local loss channel.
...
- Source requirement: [`TB-REQ-037`](../../tight-binding-domain-benchmark-requirements.md)
