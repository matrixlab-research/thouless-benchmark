...
source_requirement: TB-REQ-065
status: proposed
acceptance_class: reference
lkm_snapshot: 2026-07-27
---

# TBQ-065 — Structural-family transfer

## Scientific question

Do qualitative flat-band and localization conclusions survive new twist, relaxation, and
material families?
...
Apply the workflow without retuning numerical heuristics to held-out structures and
compare converged observables.

## Expected result

Transferable conclusions persist with calibrated uncertainty; material-specific changes
are reported rather than normalized away.
...
Hidden observable errors remain within predeclared uncertainty bands.
...
Use an unseen material pair and reconstruction model.
...
- Source requirement: [`TB-REQ-065`](../../tight-binding-domain-benchmark-requirements.md)
