...
source_requirement: TB-REQ-032
status: proposed
acceptance_class: convergence
lkm_snapshot: 2026-07-27
---

# TBQ-032 — Cross-observable localization diagnosis

## Scientific question

Do spectral and transport indicators consistently distinguish localized from extended
states?
...
Compute DOS, participation ratios, level statistics, localization length, and
conductance on matched energy and disorder grids.

## Expected result

Independent indicators agree on localized and extended regimes, while finite-size
crossover regions are labelled uncertain.
...
Agreement of phase labels on predeclared clear regimes and monotone finite-size trends.
...
Hide an energy window near a mobility edge.
...
- Source requirement: [`TB-REQ-032`](../../tight-binding-domain-benchmark-requirements.md)
