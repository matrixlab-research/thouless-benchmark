...
source_requirement: TB-REQ-077
status: proposed
acceptance_class: convergence
lkm_snapshot: 2026-07-27
---

# TBQ-077 — Singular spectral measures and localization

## Scientific question

How should fragmented or singular spectra be characterized without assuming smooth Bloch
bands?
...
Compute integrated DOS, local DOS, gap labels, participation ratios, and level
statistics across generations.

## Expected result

Integrated measures converge where defined, compact or critical states show their
expected participation scaling, and singular structure is retained.
...
State counting exact and scaling exponents stable within reported uncertainty.
...
Hide a hierarchical graph with an embedded extended band.
...
- Source requirement: [`TB-REQ-077`](../../tight-binding-domain-benchmark-requirements.md)
