...
source_requirement: TB-REQ-079
status: proposed
acceptance_class: convergence
lkm_snapshot: 2026-07-27
---

# TBQ-079 — Approximant and multifractal scaling

## Scientific question

Do states converge to localized, extended, or multifractal behaviour as approximant
order grows?
...
Fit participation moments and generalized dimensions across g and energy windows.

## Expected result

Extended, localized, and multifractal controls recover their distinct scaling;
uncertainty captures finite-generation drift.
...
Correct control classification and final exponent drift below its confidence interval.
...
Hide the largest generation and a critical energy window.
...
- Source requirement: [`TB-REQ-079`](../../tight-binding-domain-benchmark-requirements.md)
