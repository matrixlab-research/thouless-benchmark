...
source_requirement: TB-REQ-080
status: proposed
acceptance_class: reference
lkm_snapshot: 2026-07-27
---

# TBQ-080 — Geometry-family generalization

## Scientific question

Do translation-free algorithms and conclusions transfer across tilings, amorphous sets,
and fractal graphs?
...
Run identical construction, spectral, topology, and convergence interfaces on held-out
geometry families.

## Expected result

Algorithms require no periodic metadata; only physically universal conclusions transfer
and family-specific spectra remain distinguishable.
...
All exact graph checks pass and hidden observables meet family-specific references.
...
Use an unseen tiling and correlated amorphous point process.
...
- Source requirement: [`TB-REQ-080`](../../tight-binding-domain-benchmark-requirements.md)
