...
source_requirement: TB-REQ-004
status: proposed
acceptance_class: exact
lkm_snapshot: 2026-07-27
---

# TBQ-004 — Symmetry preservation and negative controls

## Scientific question

Does model construction preserve declared unitary and antiunitary symmetries while
detecting a real symmetry-breaking perturbation?
...
Evaluate symmetry covariance residuals before and after adding a controlled onsite or
hopping perturbation delta.

## Expected result

Residuals vanish at delta=0 and grow with the imposed perturbation; a broken symmetry is
not reported as exact.
...
Exact cases require residual below 1e-11; the detected breaking must scale linearly with
small delta within 5 percent.
...
Hide the broken generator and perturb a different orbital channel.
...
- Source requirement: [`TB-REQ-004`](../../tight-binding-domain-benchmark-requirements.md)
