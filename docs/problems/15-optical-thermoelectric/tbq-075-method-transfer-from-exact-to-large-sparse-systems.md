...
source_requirement: TB-REQ-075
status: executable
acceptance_class: scaling
lkm_snapshot: 2026-07-27
---

# TBQ-075 — Method transfer from exact to large sparse systems

## Scientific question

Can a validated response calculation retain accuracy after switching from
diagonalization to sparse time or polynomial methods?
...
Establish overlap on small and intermediate sizes, then scale the sparse route to a
large disordered lattice.

## Expected result

Sparse and exact responses agree in the overlap regime; large cases satisfy sum rules
and convergence without dense matrices.
...
Overlap error below 2 percent and fixed-memory scaling consistent with sparsity.
...
Hide the largest size and a different disorder strength.
...
- Source requirement: [`TB-REQ-075`](../../tight-binding-domain-benchmark-requirements.md)
