...
source_requirement: TB-REQ-071
status: executable
acceptance_class: exact
lkm_snapshot: 2026-07-27
---

# TBQ-071 — Hamiltonian-consistent response operators

## Scientific question

Are velocity, charge-current, and heat-current operators consistent with the Hamiltonian
...
Compare commutator, momentum-derivative, and finite-flux definitions where each applies.

## Expected result

Equivalent operator definitions agree, satisfy Hermiticity, and include overlap or
periodic-position corrections when required.
...
Operator norm mismatch below 1e-9 on exact periodic cases.
...
Hide a non-orthogonal basis and long-range hopping.
...
- Source requirement: [`TB-REQ-071`](../../tight-binding-domain-benchmark-requirements.md)
