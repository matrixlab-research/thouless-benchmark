...
| --- | --- | --- | --- | --- | --- |
| TBQ-001 | [Basis and generalized-Hermiticity fidelity](problems/01-model-construction/tbq-001-basis-and-generalized-hermiticity-fidelity.md) | implementable, unverified | missing capability | missing capability | none |
| TBQ-002 | [Energy-window and subspace fidelity](problems/01-model-construction/tbq-002-energy-window-and-subspace-fidelity.md) | implementable, unverified | missing capability | missing capability | none |
| TBQ-003 | [Controlled hopping truncation](problems/01-model-construction/tbq-003-controlled-hopping-truncation.md) | implementable, unverified | missing capability | missing capability | none |
| TBQ-004 | [Symmetry preservation and negative controls](problems/01-model-construction/tbq-004-symmetry-preservation-and-negative-controls.md) | implementable, unverified | missing capability | missing capability | none |
| TBQ-005 | [Transfer beyond fitted structures](problems/01-model-construction/tbq-005-transfer-beyond-fitted-structures.md) | implementable, unverified | missing capability | missing capability | none |
...
| TBQ-008 | [Van Hove and flat-band feature resolution](problems/02-bands-dos-fermiology/tbq-008-van-hove-and-flat-band-feature-resolution.md) | implementable, unverified | implementable, unverified | implementable, unverified | none |
| TBQ-009 | [Fermi-surface topology and Lifshitz transitions](problems/02-bands-dos-fermiology/tbq-009-fermi-surface-topology-and-lifshitz-transitions.md) | implementable, unverified | implementable, unverified | implementable, unverified | none |
...
| TBQ-014 | [Low-field Landau-level correspondence](problems/03-magnetic-flux-hofstadter/tbq-014-low-field-landau-level-correspondence.md) | implementable, unverified | implementable, unverified | implementable, unverified | none |
| TBQ-015 | [Rational-approximant convergence](problems/03-magnetic-flux-hofstadter/tbq-015-rational-approximant-convergence.md) | implementable, unverified | implementable, unverified | implementable, unverified | none |
| TBQ-016 | [Gauge-invariant bulk indices](problems/04-bulk-topology/tbq-016-gauge-invariant-bulk-indices.md) | implementable, unverified | implementable, unverified | implementable, unverified | none |
| TBQ-017 | [Topological phase-boundary localization](problems/04-bulk-topology/tbq-017-topological-phase-boundary-localization.md) | implementable, unverified | implementable, unverified | implementable, unverified | none |
| TBQ-018 | [Degeneracy-safe Wilson and nested Wilson flow](problems/04-bulk-topology/tbq-018-degeneracy-safe-wilson-and-nested-wilson-flow.md) | implementable, unverified | implementable, unverified | implementable, unverified | none |
...
| TBQ-020 | [Trivial, nearly gapless, and basis-adversarial controls](problems/04-bulk-topology/tbq-020-trivial-nearly-gapless-and-basis-adversarial-controls.md) | implementable, unverified | implementable, unverified | implementable, unverified | none |
| TBQ-021 | [Termination families from one bulk model](problems/05-boundaries-bulk-boundary/tbq-021-termination-families-from-one-bulk-model.md) | implementable, unverified | implementable, unverified | implementable, unverified | none |
...
| TBQ-023 | [Finite-spectrum and surface-Green-function agreement](problems/05-boundaries-bulk-boundary/tbq-023-finite-spectrum-and-surface-green-function-agreement.md) | implementable, unverified | missing capability | implementable, unverified | none |
| TBQ-024 | [Conditional bulk-boundary correspondence](problems/05-boundaries-bulk-boundary/tbq-024-conditional-bulk-boundary-correspondence.md) | implementable, unverified | implementable, unverified | implementable, unverified | none |
| TBQ-025 | [Geometry-family generalization](problems/05-boundaries-bulk-boundary/tbq-025-geometry-family-generalization.md) | implementable, unverified | implementable, unverified | implementable, unverified | none |
| TBQ-026 | [Gauge covariance of geometric tensors](problems/06-quantum-geometry-response/tbq-026-gauge-covariance-of-geometric-tensors.md) | implementable, unverified | implementable, unverified | missing capability | none |
| TBQ-027 | [Competing nonlinear Hall mechanisms](problems/06-quantum-geometry-response/tbq-027-competing-nonlinear-hall-mechanisms.md) | implementable, unverified | implementable, unverified | implementable, unverified | none |
| TBQ-028 | [Symmetry-forbidden nonlinear tensor components](problems/06-quantum-geometry-response/tbq-028-symmetry-forbidden-nonlinear-tensor-components.md) | implementable, unverified | implementable, unverified | implementable, unverified | none |
...
| TBQ-030 | [Zero-Chern nonlinear bulk-boundary workflow](problems/06-quantum-geometry-response/tbq-030-zero-chern-nonlinear-bulk-boundary-workflow.md) | implementable, unverified | missing capability | implementable, unverified | none |
| TBQ-031 | [Reproducible disorder ensembles](problems/07-disorder-localization/tbq-031-reproducible-disorder-ensembles.md) | implementable, unverified | missing capability | missing capability | none |
...
| TBQ-037 | [Scattering conservation and local continuity](problems/08-open-transport/tbq-037-scattering-conservation-and-local-continuity.md) | implementable, unverified | not applicable | implementable, unverified | none |
| TBQ-038 | [Transmission, local density, and finite-temperature noise](problems/08-open-transport/tbq-038-transmission-local-density-and-finite-temperature-noise.md) | implementable, unverified | not applicable | implementable, unverified | none |
| TBQ-039 | [Numerical stability for long evanescent devices](problems/08-open-transport/tbq-039-numerical-stability-for-long-evanescent-devices.md) | implementable, unverified | not applicable | implementable, unverified | none |
| TBQ-040 | [Generalization across contact families](problems/08-open-transport/tbq-040-generalization-across-contact-families.md) | implementable, unverified | not applicable | implementable, unverified | none |
...
| TBQ-045 | [Continuum-to-lattice BdG convergence](problems/09-superconducting-bdg/tbq-045-continuum-to-lattice-bdg-convergence.md) | implementable, unverified | missing capability | implementable, unverified | none |
| TBQ-046 | [Biorthogonal eigenvectors and residuals](problems/10-non-hermitian/tbq-046-biorthogonal-eigenvectors-and-residuals.md) | implementable, unverified | not applicable | not applicable | none |
| TBQ-047 | [Exceptional-point order and sensitivity](problems/10-non-hermitian/tbq-047-exceptional-point-order-and-sensitivity.md) | implementable, unverified | not applicable | not applicable | none |
...
| TBQ-049 | [Periodic-open mismatch and skin localization](problems/10-non-hermitian/tbq-049-periodic-open-mismatch-and-skin-localization.md) | implementable, unverified | not applicable | not applicable | none |
| TBQ-050 | [Non-Hermitian family generalization](problems/10-non-hermitian/tbq-050-non-hermitian-family-generalization.md) | implementable, unverified | not applicable | not applicable | none |
...
| TBQ-061 | [Commensurate and reconstructed geometry](problems/13-moire-strain-supercells/tbq-061-commensurate-and-reconstructed-geometry.md) | implementable, unverified | missing capability | implementable, unverified | none |
| TBQ-062 | [Geometry-dependent coupling laws](problems/13-moire-strain-supercells/tbq-062-geometry-dependent-coupling-laws.md) | implementable, unverified | missing capability | implementable, unverified | none |
...
| TBQ-067 | [Charge, spin, orbital-current, and torque continuity](problems/14-magnetism-spin-orbital/tbq-067-charge-spin-orbital-current-and-torque-continuity.md) | implementable, unverified | missing capability | implementable, unverified | none |
| TBQ-068 | [Mechanism-resolved Hall response](problems/14-magnetism-spin-orbital/tbq-068-mechanism-resolved-hall-response.md) | implementable, unverified | implementable, unverified | implementable, unverified | none |
| TBQ-069 | [Texture-resolution and adiabatic convergence](problems/14-magnetism-spin-orbital/tbq-069-texture-resolution-and-adiabatic-convergence.md) | implementable, unverified | missing capability | implementable, unverified | none |
| TBQ-070 | [Magnetic-family generalization](problems/14-magnetism-spin-orbital/tbq-070-magnetic-family-generalization.md) | implementable, unverified | missing capability | implementable, unverified | none |
| TBQ-071 | [Hamiltonian-consistent response operators](problems/15-optical-thermoelectric/tbq-071-hamiltonian-consistent-response-operators.md) | implementable, unverified | missing capability | missing capability | none |
...
| TBQ-073 | [Thermoelectric and Onsager relations](problems/15-optical-thermoelectric/tbq-073-thermoelectric-and-onsager-relations.md) | implementable, unverified | missing capability | implementable, unverified | none |
...
| TBQ-075 | [Method transfer from exact to large sparse systems](problems/15-optical-thermoelectric/tbq-075-method-transfer-from-exact-to-large-sparse-systems.md) | implementable, unverified | missing capability | implementable, unverified | none |
| TBQ-076 | [Translation-free geometric construction](problems/16-aperiodic-amorphous-fractal/tbq-076-translation-free-geometric-construction.md) | implementable, unverified | missing capability | implementable, unverified | none |
...
| TBQ-081 | [Provenance-preserving structural defects](problems/17-defects-interfaces/tbq-081-provenance-preserving-structural-defects.md) | implementable, unverified | implementable, unverified | implementable, unverified | none |
| TBQ-082 | [Defect-specific local chemistry](problems/17-defects-interfaces/tbq-082-defect-specific-local-chemistry.md) | implementable, unverified | missing capability | implementable, unverified | none |
| TBQ-083 | [Embedding and supercell agreement](problems/17-defects-interfaces/tbq-083-embedding-and-supercell-agreement.md) | implementable, unverified | missing capability | implementable, unverified | none |
| TBQ-084 | [Local-state and transport consequences](problems/17-defects-interfaces/tbq-084-local-state-and-transport-consequences.md) | implementable, unverified | missing capability | implementable, unverified | none |
| TBQ-085 | [Defect-family generalization](problems/17-defects-interfaces/tbq-085-defect-family-generalization.md) | implementable, unverified | missing capability | implementable, unverified | none |
| TBQ-086 | [One physical question across scales](problems/18-multiscale-validation/tbq-086-one-physical-question-across-scales.md) | implementable, unverified | missing capability | implementable, unverified | none |
| TBQ-087 | [Explicit representation mapping](problems/18-multiscale-validation/tbq-087-explicit-representation-mapping.md) | implementable, unverified | missing capability | missing capability | none |
| TBQ-088 | [Gauge-invariant observable comparison](problems/18-multiscale-validation/tbq-088-gauge-invariant-observable-comparison.md) | implementable, unverified | missing capability | implementable, unverified | none |
| TBQ-089 | [Discrepancy decomposition](problems/18-multiscale-validation/tbq-089-discrepancy-decomposition.md) | implementable, unverified | missing capability | implementable, unverified | none |
| TBQ-090 | [External-family validation](problems/18-multiscale-validation/tbq-090-external-family-validation.md) | implementable, unverified | missing capability | implementable, unverified | none |
...
| TBQ-093 | [Separated numerical error budget](problems/19-scientific-scale-numerics/tbq-093-separated-numerical-error-budget.md) | implementable, unverified | not applicable | implementable, unverified | none |
| TBQ-094 | [Accuracy-preserving time and memory scaling](problems/19-scientific-scale-numerics/tbq-094-accuracy-preserving-time-and-memory-scaling.md) | implementable, unverified | not applicable | implementable, unverified | none |
| TBQ-095 | [Reproducible transition from exact to production scale](problems/19-scientific-scale-numerics/tbq-095-reproducible-transition-from-exact-to-production-scale.md) | implementable, unverified | not applicable | implementable, unverified | none |
...
| --- | --- | --- | --- | --- |
| TBQ-001 | thouless | implementable, unverified | `periodic_model`, `generalized_eigensystem` | none |
...
| TBQ-002 | thouless | implementable, unverified | `periodic_model`, `generalized_eigensystem`, `dense_spectrum`, `topological_inputs` | none |
...
| TBQ-003 | thouless | implementable, unverified | `periodic_model`, `generalized_eigensystem`, `dense_spectrum`, `frequency_response` | none |
...
| TBQ-004 | thouless | implementable, unverified | `periodic_model`, `generalized_eigensystem`, `dense_spectrum`, `parameterized_models` | none |
...
| TBQ-005 | thouless | implementable, unverified | `periodic_model`, `generalized_eigensystem`, `dense_spectrum`, `parameterized_models` | none |
...
| TBQ-008 | thouless | implementable, unverified | `periodic_model`, `dense_spectrum` | none |
...
| TBQ-009 | thouless | implementable, unverified | `periodic_model`, `dense_spectrum` | none |
...
| TBQ-014 | thouless | implementable, unverified | `periodic_model`, `magnetic_models`, `dense_spectrum` | none |
...
| TBQ-015 | thouless | implementable, unverified | `periodic_model`, `finite_model`, `magnetic_models`, `topological_inputs` | none |
...
| TBQ-016 | thouless | implementable, unverified | `periodic_model`, `dense_spectrum`, `topological_inputs` | none |
...
| TBQ-017 | thouless | implementable, unverified | `periodic_model`, `dense_spectrum`, `topological_inputs`, `parameterized_models` | none |
...
| TBQ-018 | thouless | implementable, unverified | `periodic_model`, `dense_spectrum`, `topological_inputs` | none |
...
| TBQ-020 | thouless | implementable, unverified | `periodic_model`, `dense_spectrum`, `topological_inputs`, `parameterized_models` | none |
...
| TBQ-021 | thouless | implementable, unverified | `periodic_model`, `finite_model` | none |
...
| TBQ-023 | thouless | implementable, unverified | `finite_model`, `dense_spectrum`, `surface_green_function` | none |
...
| TBQ-024 | thouless | implementable, unverified | `periodic_model`, `finite_model`, `dense_spectrum`, `topological_inputs` | none |
...
| TBQ-025 | thouless | implementable, unverified | `periodic_model`, `finite_model`, `dense_spectrum` | none |
...
| TBQ-026 | thouless | implementable, unverified | `periodic_model`, `dense_spectrum`, `quantum_geometry`, `analytic_hamiltonian_derivatives` | none |
...
| TBQ-027 | thouless | implementable, unverified | `periodic_model`, `quantum_geometry`, `frequency_response` | none |
...
| TBQ-028 | thouless | implementable, unverified | `periodic_model`, `quantum_geometry`, `frequency_response` | none |
...
| TBQ-030 | thouless | implementable, unverified | `periodic_model`, `finite_model`, `quantum_geometry`, `steady_state_transport` | none |
...
| TBQ-031 | thouless | implementable, unverified | `finite_model`, `parameterized_models`, `nonhermitian_spectrum` | none |
...
| TBQ-037 | thouless | implementable, unverified | `steady_state_transport`, `local_continuity`, `transport_noise` | none |
...
| TBQ-038 | thouless | implementable, unverified | `steady_state_transport`, `local_continuity`, `transport_noise` | none |
...
| TBQ-039 | thouless | implementable, unverified | `steady_state_transport`, `long_device_solver` | none |
...
| TBQ-040 | thouless | implementable, unverified | `steady_state_transport`, `surface_green_function`, `parameterized_models` | none |
...
| TBQ-045 | thouless | implementable, unverified | `finite_model`, `dense_spectrum`, `static_bdg`, `parameterized_models`, `continuum_discretization` | none |
...
| TBQ-046 | thouless | implementable, unverified | `nonhermitian_spectrum` | none |
...
| TBQ-047 | thouless | implementable, unverified | `nonhermitian_spectrum`, `parameterized_models` | none |
...
| TBQ-049 | thouless | implementable, unverified | `nonhermitian_spectrum`, `finite_model`, `periodic_model` | none |
...
| TBQ-050 | thouless | implementable, unverified | `nonhermitian_spectrum`, `finite_model`, `parameterized_models` | none |
...
| TBQ-061 | thouless | implementable, unverified | `large_sparse_geometry` | none |
...
| TBQ-062 | thouless | implementable, unverified | `large_sparse_geometry`, `parameterized_models` | none |
...
| TBQ-067 | thouless | implementable, unverified | `finite_model`, `spin_observables`, `local_continuity` | none |
...
| TBQ-068 | thouless | implementable, unverified | `periodic_model`, `spin_observables`, `frequency_response` | none |
...
| TBQ-069 | thouless | implementable, unverified | `finite_model`, `spin_observables`, `steady_state_transport` | none |
...
| TBQ-070 | thouless | implementable, unverified | `finite_model`, `spin_observables`, `steady_state_transport`, `parameterized_models` | none |
...
| TBQ-071 | thouless | implementable, unverified | `generalized_eigensystem`, `sparse_operators`, `response_operators` | none |
...
| TBQ-073 | thouless | implementable, unverified | `thermoelectric_response`, `sparse_operators`, `parameterized_models` | none |
...
| TBQ-075 | thouless | implementable, unverified | `frequency_response`, `kernel_polynomial`, `sparse_operators` | none |
...
| TBQ-076 | thouless | implementable, unverified | `arbitrary_graphs`, `finite_model`, `large_sparse_geometry` | none |
...
| TBQ-081 | thouless | implementable, unverified | `arbitrary_graphs`, `finite_model` | none |
...
| TBQ-082 | thouless | implementable, unverified | `arbitrary_graphs`, `finite_model`, `dense_spectrum`, `embedding_green_function` | none |
...
| TBQ-083 | thouless | implementable, unverified | `finite_model`, `dense_spectrum`, `embedding_green_function` | none |
...
| TBQ-084 | thouless | implementable, unverified | `finite_model`, `dense_spectrum`, `steady_state_transport` | none |
...
| TBQ-085 | thouless | implementable, unverified | `arbitrary_graphs`, `finite_model`, `sparse_operators`, `kernel_polynomial`, `parameterized_models` | none |
...
| TBQ-086 | thouless | implementable, unverified | `periodic_model`, `finite_model`, `dense_spectrum`, `sparse_operators`, `continuum_discretization`, `parameterized_models` | none |
...
| TBQ-087 | thouless | implementable, unverified | `periodic_model`, `finite_model`, `generalized_eigensystem`, `dense_spectrum`, `topological_inputs` | none |
...
| TBQ-088 | thouless | implementable, unverified | `periodic_model`, `finite_model`, `sparse_operators`, `topological_inputs`, `steady_state_transport`, `frequency_response` | none |
...
| TBQ-089 | thouless | implementable, unverified | `periodic_model`, `finite_model`, `dense_spectrum`, `sparse_operators`, `parameterized_models` | none |
...
| TBQ-090 | thouless | implementable, unverified | `periodic_model`, `finite_model`, `dense_spectrum`, `sparse_operators`, `parameterized_models` | none |
...
| TBQ-093 | thouless | implementable, unverified | `sparse_operators`, `kernel_polynomial`, `iterative_linear_solver` | none |
...
| TBQ-094 | thouless | implementable, unverified | `sparse_operators`, `kernel_polynomial` | none |
...
| TBQ-095 | thouless | implementable, unverified | `large_sparse_geometry`, `sparse_operators`, `kernel_polynomial`, `parameterized_models` | none |
